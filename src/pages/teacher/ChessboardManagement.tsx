...
function ChessboardManagement() {
  ...
  const [chessboards, setChessboards] = useState<ChessBoardInfo[]>([]) // 保存从后端获取的挑战数据
  ...
  useEffect(() => {
    fetchChessboards().then() // 页面加载时获取挑战列表
  }, [])
        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div
              ...
              <h2 className="text-xl font-semibold mb-4">所有挑战</h2>
